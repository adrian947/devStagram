...
@section('content')
    <div class="justify-center md:flex md:gap-4">
        <div class="md:w-4/12">
            <img src="{{ asset('img/registrar.jpg') }}" alt="image register" class="rounded-lg">
        </div>
        <div class="rounded-lg bg-white p-4 shadow md:w-4/12">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-5">
                    <div>
                        <label for="name" class="mb-2 block font-bold uppercase text-gray-500">Name</label>
                    </div>
                ...
                <div class="mb-5">
                    <div>
                        <label for="password_confirmation" class="mb-2 block font-bold uppercase text-gray-500">Repeat
                            Password</label>
                    </div>
                    <input id="password_confirmation" name="password_confirmation" type="password"
                        placeholder="Enter your password again" class="w-full rounded-lg border p-3" />
                </div>
